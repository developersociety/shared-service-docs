...
(function ($, Drupal) {
  ...
  /**
   * An accessible collapsible section pattern: https://inclusive-components.design/collapsible-sections/
   */
          ...
          if (document.head.attachShadow) {
            ...
            buttons.innerHTML = `
              ...
              <ul class="controls" aria-label="section controls">
                <li><button id="expand">expand all filters</button></li>
                <li><button id="collapse">collapse all filters</button></li>
              </ul>
              `
